...
def template_viz_routes() -> pd.DataFrame:
    ...
    add("AG_MED_CAPE", "AG", "MED",
        ...
        [[26.6,56.4],[15,63],[5,55],[-5,48],[-15,38],[-25,28],[-34.4,18.5],
         [-38,12],[-30,-5],[-20,-15],[-10,-20],[0,-10],[10,0],[20,5],
         [30,0],[35,-3],[37.5,18]])
    ...
    add("BALT_MED",    "BALT", "MED",
        ...
        [[58.3,17.1],[57.8,10.5],[54,7],[50,2],[46,3],[42,10],[38,5],
         [35.98,-5.45],[36,0],[37.5,18]])

    # ── North Sea / UK Continent ──────────────────────────────────────────
    add("NSEA_MED",    "NSEA", "MED",
        "Gibraltar Strait",
        [[60.5,5.3],[56,3],[52,3],[48,2],[46,3],[43,6],[40,10],[38,5],
         [35.98,-5.45],[36,0],[37.5,18]])
    ...
    add("UKC_MED",     "UKC", "MED",
        "Gibraltar Strait",
        [[51.3,-2.1],[49,0],[46,2],[43,5],[40,10],[38,5],[35.98,-5.45],[36,0],[37.5,18]])
    ...
    add("WAF_MED",     "WAF", "MED",
        "Gibraltar Strait",
        [[7.4,0.4],[12,-2],[20,-5],[28,-2],[33,0],[36,5],[35.98,-5.45],[36,0],[37.5,18]])
    ...
    add("SAFR_MED",     "SAFR", "MED",
        ...
        [[-31.2,23.0],[-34.4,18.5],[-30,8],[-20,3],[-10,0],[5,-3],[18,-2],
         [28,0],[33,5],[35.98,-5.45],[36,2],[37.5,18]])

    add("SAFR_NSEA",    "SAFR", "NSEA",
        "Cape of Good Hope;Gibraltar Strait",
        [[-31.2,23.0],[-34.4,18.5],[-25,5],[-12,2],[0,-2],[12,-3],[22,-5],
         [30,-10],[35.98,-5.45],[40,0],[46,2],[50,2],[57,2],[60.5,5.3]])

    add("SAFR_UKC",     "SAFR", "UKC",
        "Cape of Good Hope",
        [[-31.2,23.0],[-34.4,18.5],[-25,5],[0,-2],[18,-8],[28,-10],
         [35.98,-5.45],[44,0],[48,-2],[51.3,-2.1]])
